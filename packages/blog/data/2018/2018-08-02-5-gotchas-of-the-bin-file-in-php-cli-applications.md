...
perex: |
    This post from [Master PHP CLI Apps with Symfony](/cluster/master-php-cli-apps-with-symfony/) cluster will focus on bin files. It's the smallest part of PHP CLI Application, so I usually start with it.
    <br><br>
...
Do you want to know more? See the [PHP CLI APP cluster](/cluster/master-php-cli-apps-with-symfony/).
