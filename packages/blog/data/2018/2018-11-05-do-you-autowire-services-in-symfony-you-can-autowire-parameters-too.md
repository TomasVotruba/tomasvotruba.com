...
deprecated_message: |
    The [AutoBindParameter](https://github.com/symplify/auto-bind-parameter) package is now deprecated. Parameter autowiring proven to be magical and clear approach.
    <br>
    <br>
