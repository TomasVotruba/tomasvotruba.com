...
- Open Travis for your repository: [https://travis-ci.org/TomasVotruba/tomasvotruba.cz](https://travis-ci.org/TomasVotruba/tomasvotruba.cz)
...
- And let `.travis.yml` know, that he should publish it
    ...
    script:
        # tweets posts
        - if [[ $TRAVIS_BRANCH == "master" && $TRAVIS_PULL_REQUEST == "false" ]]; then vendor/bin/publish-new-tweet; fi
    ```
