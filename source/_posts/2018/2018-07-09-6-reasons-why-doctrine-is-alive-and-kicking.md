...
perex: |
    ...
    <br><br>
    **May this be an inspiration for open-source projects that find themselves stuck and their maintainers that find themselves unhappy**.
...
Doctrine bumped **all packages** to min PHP 7.1. This change reduces a lot of feature that have to be maintained. But that's not the best benefits in my opinion. The best thing is **the maintainer doesn't have to keep in mind all the clutter know-how** he or she probably uses only for this project, like arrays should be written in `array()`, there is no `void` yet or `yield` yet etc. This makes development much more faster and enjoyable.
...
Until we agree on regular PHP minor version bumping as a community, I think it's the best to jump to *the unicorn* versions. Those with biggest impact, the most stable and helpful - and [go PHP 7.1](https://gophp71.org/) sa one.

## 2. Use Coding Standard

Although coding standard are standard nowadays, it's not very easy to setup them to existing projects. Moreover more complex ones than few basic rules. I'm very happy to see that Doctrine made this happen. The [`ruleset.xml`](https://github.com/doctrine/coding-standard/blob/master/lib/Doctrine/ruleset.xml) is quite rich.

Coding Standard makes contributing much more fear-less, since **you don't have to worry I'll get smashed in code-review by "extra space here" comment**.

Since it uses only PHP_CodeSniffer and not PHP CS Fixer, these is still lot of manual work and space for huge cost-effective improvement. I tried to help with EasyCodingStandard implementation many months ago, but in that time ECS required PHP 7.1 and Doctrine not and used Neon of Yaml to configure. Not anymore! [Yaml is now default since ECS 4](https://www.tomasvotruba.cz/blog/2018/03/26/new-in-easy-coding-standard-4-clean-symfony-standard-with-yaml-and-services/), so path is open from technical point of view.
...
<div class="text-center">
    <img src="/assets/images/posts/2018/doctrine-alive/baloon.jpg" class="img-thumbnail">
    <br>
    <em>
        It's like a hot air baloon.<br>
...
*Over-support* is very common in open source. It happened to me in ECS, [I saw it ApiGen](/blog/2017/09/04/how-apigen-survived-its-own-death/) and almost burned out while getting rid of it (it also took me many month to even realize it and step out of it). **People request features, your projects is popular, you gave people these features and that makes it more popular, so more people request features... it's challenging to keep on track when you're on celebrity power-trip**.
...
How can people orientate in the product, the package, the ideas, if you have no information about it? People need to know, what will happen when - at least approximately, but moreover in software that changes so fast. There were times, when there was one post for whole year [on Doctrine's blog](https://www.doctrine-project.org/blog/). That changed!

The blog was refreshed, [fully-open sourced](https://github.com/doctrine/doctrine-website/) and now runs on Sculpin, a project that I used before and get lof of inspiration for [Statie](https://www.statie.org/).

There are news about Doctrine ORM 3.0 about PHP 7.1 bump etc. Even these small notes give a great feeling of trust, of *something is going on* feeling, that creates a relationship.

## 5. From Talks and Post Evangelization to Code Improvements

I didn't really measure myself this so [I can't fake it](https://www.goodreads.com/quotes/300097-i-only-believe-in-statistics-that-i-doctored-myself), but I have a feeling that these is less talks and posts about Doctrine than years before. And that's a good think. Why? Because this energy is now directed to the code.

<img src="/assets/images/posts/2018/doctrine-alive/contrib.png" class="img-thumbnail">

Don't take me wrong, both development and popularization are important, but if the project is not moving ahead, the popularition only vendor-lock know-ledge to slowly deprecating code.
...
I think you know what a great feeling is to work with clean desk. How does that related to an open-source project?

**Tagging** packages is like [publishing a book](https://www.doctrine-project.org/2017/07/25/php-7.1-requirement-and-composer.html). You summarize all you know, all you did up-to the one point of time. It's a big step, you celebrate it and... then you continue working on your next book.
