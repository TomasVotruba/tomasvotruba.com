...
perex: |
    You're probably thinking: "He's joking, right? That's kind of that title, that is parody to show us we should do it."
    <br>
    <br> 
    **No, I really don't think we should read books, nor feel bad for not reading them**. And now talk about non-fiction books with knowledge that readers want to use in their lives.
    <br>
    <br>
...
I've read [256 Bloghacks](/blog/2018/04/12/the-best-5-of-256-bloghacks-book/), [Steal Like an Artist, Deep Work, No More Mr. Nice Guy](/blog/2017/09/25/3-non-it-books-that-help-you-to-become-better-programmer/), [Selling is Human](/blog/2018/06/18/14-surprising-tip-from-selling-is-human-to-influence-others/) and [Life 3.0](/blog/2017/12/04/life30-what-will-you-do-when-ai-takes-over-the-world/) during last 2 years and couple more I didn't write about yet.

<img src="/assets/images/posts/2018/no-books/fahrenheit-book.jpg" class="img-thumbnail">

I mostly love books.

I just don't think it's the best written format to learn from and that such format can actually hurt learning. It's not the author, the topic, but really the format to blame.
...
And be sure let me know in the comments if you [disagree](http://www.paulgraham.com/disagree.html). 

## Best-Seller vs. Best-Read

I'm known to be a minimalist so my book shelf bears only 5 books, while all my other friends have 20-30 books. I always wondered "do they read so fast, wow they're smart"? Then I start asking curious question:
...
The I realized that "best seller" has nothing to do with the content. It's like having a cool free application in your phone that you never use or famous "friend" on Facebook you never write but anyone can see you're "friends".

Hype beats knowledge, at least at the time being. **It's less important how book really is valuable to the reader then how cool it is, how nice cover it has, how many of my friends and celebrities recommend it**.
...
Imagine this post would have 20 pages. I would go on detail, start to talk about my day and how everyday life is connected to reading books and what I read in my childhood and formed me to who I am... bla bla bla.
...
<blockquote class="blockquote text-center">
    "Give me a man week to finish a 4-hour work &ndash; he'll finish it in a week.
    <br>
...
Do you buy "a Symfony book" and read it? And than you know Symfony? You might and you'll might be feeling great about it.
...
But what do so much of random education (it has it's meaning, but not here) if your first task is to create a contact form? Maybe there are [posts about writing forms that go beyond the documentation](https://github.com/pehapkari/awesome-symfony-education#forms) that take you 20 minutes to read. 
...
<img src="https://images.clipartuse.com/a455c631591f21d0dfdad4372b4dabba_tree-fall-spring-summer-winter-clip-art-at-clkercom-vector-clip-_1053-218.svg" class="img-thumbnail">
...
Same vendor lock happens to knowledge. You can see it most of school systems, where 40 years old people teach 15 years their "up-to-date" know-how. People write PHP 7 as PHP 5.3, because there are so many old books out there.

### Wikipedia 2010 in 2018?

**Imagine that Wikipedia would be published just once 10 years as a book**. So today, in 2018, somebody would quote a 8 year old information it it's school essay. It's crazy, right? But that's how books work naturally.
...
<blockquote class="blockquote text-center">
    I believe the community of people knows much more then the most skilled person in it
</blockquote>
...
That way the content is cooperative work of more people, more authors would be happy to share it and get credit for it. 3 posts about Symfony Console [proven practise](@todo post) by 3 different authors can never be as good as 1 written by 3 authors together.   
...
It makes no sense that everyone would read the same book from beggingin till the end. Instead you can start at lvl 5, I cna start lvl 2, and someboy only wants the lvl 10, if there is something new he can learn in the field he enyjor the most.

With a cluster of posts, you can see clearly where to start and what you want to read.

### The Next Nearest Skill 

This is connected to *prerequisit skill* system. Each skill is followed by the nearest one that is super eyouenasy to learn

 imagine you drive a bike, then motorcycle, then a car and than a bus
 then imagine you drive a bike then you jump directly to bus
 
  which cna build on previous experience? thus faster and esier forn neurons to connect?


### Inform Clearly about Deprecations and Changes

The last but most least, people often return to content they believe in and look for iterative improvement in it. That's why we use Stackoverflow and see answers that worked in 2015 to have 100 vote, but also there is a new on in 2018, that has alread 20 votest and in 2020 there will come even better one...

That's why I try to make clear what and how changed right in the begginign on such psots:

@todo screen of updated/deprecated post

You might seem this as redudnat work and that I'm a nerd (guilty!), but I'm super-focused on you, my readres and I want you to understand every change that happens so you can learn fast and safe.
