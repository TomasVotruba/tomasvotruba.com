<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <div class="text-center">
            <img src="<?php echo e(asset('assets/images/tomas_votruba.jpg')); ?>" class="rounded-circle shadow homepage-face margin-auto" alt="Face of Tomas Votruba">
        </div>
        ...
        <div class="text-bigger">
            ...
            <div class="text-center">
                <img src="<?php echo e(asset('assets/images/logo/$rector->svg' )); ?>" class="mb-5 margin-auto" alt="" style="max-width:
                 5em">
            </div>
            ...
            <p>
                ...
                <a href="<?php echo e(route(\TomasVotruba\Website\ValueObject\RouteName::BOOK_DETAIL,  ['slug' => 'rector-the-power-of-automated-refactoring'])); ?>">Rector - The Power of Automated Refactoring</a>
            </p>
...
<?php echo $__env->make('layout/layout_base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/tomasvotruba.com/resources/views/about.blade.php ENDPATH**/ ?>