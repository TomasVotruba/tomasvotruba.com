...
This is very important for projects like [Rector](https://getrector.com/) or [ECS](https://github.com/symplify/easy-coding-standard/), as you'll use them to analyze or refactor code that uses Symfony.
