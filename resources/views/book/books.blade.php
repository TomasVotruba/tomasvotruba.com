        ...
        <div class="row">
            @foreach ($books as $book)
                ...
                <div class="text-center col-12 col-md-6 mb-5 mt-4">
                    <a href="{{ action(\App\Http\Controller\BookDetailController::class, ['slug' => $book->getSlug()]) }}">
                    ...
                    <a
                        href="{{ action(\App\Http\Controller\BookDetailController::class, ['slug' => $book->getSlug()]) }}"
                        target="blank"
                        @class([
