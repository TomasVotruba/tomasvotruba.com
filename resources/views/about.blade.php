    ...
    <div class="container">
        ...
        <div class="text-bigger">
            ...
            <p>
                ...
                <a href="{{ action(\App\Http\Controllers\BookDetailController::class,  ['slug' => 'rector-the-power-of-automated-refactoring']) }}">Rector
            ...
            <div class="text-center mb-5">
                ...
                <svg width="80" height="75" class="margin-auto homepage-logo" viewBox="0 0 80 75"
                     xmlns="http://www.w3.org/2000/svg" data-v-218f9b69="">
                    <g fill="none" fill-rule="evenodd">
                        <path fill="#F6C247"
                              d="M63.196 48.5l2.126 26.188-24.585-11.316-25.364 10.696 1.72-25.563L0 29.013l27.775-7.464L40.135 0l14.262 23.331L80 28.688 63.196 48.5"></path>
                        <path
            ...
            <p>
                I founded <a href="https://pehapkari.cz/">Czech PHP community</a> in 2015 to connect Czech PHP groups
                into united one, where we organized 50+ meetups and 20+ trainings across 5 cities.
            </p>

            <p>
                I love to share my experience in <a href="https://joind.in/user/TomasVotruba"> conferences talks</a>.
                "The best way to learn is to teach others", I try my best in <a
                    href="https://stackoverflow.com/users/1348344/tomas-votruba">top 2 % in Stackoverflow</a>.
            </p>
            <p>
