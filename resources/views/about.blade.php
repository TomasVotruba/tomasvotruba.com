    ...
    <div class="container">
        ...
        <div class="text-bigger">
            ...
            <p>
                ...
                <a href="{{ route(\TomasVotruba\Website\Enum\RouteName::BOOK_DETAIL,  ['slug' => 'rector-the-power-of-automated-refactoring']) }}">Rector - The Power of Automated Refactoring</a>
            </p>
