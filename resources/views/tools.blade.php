...
@section('content')
    <div class="container">
        ...
        <div class="mt-4 mb-4">
            <p>
                There is a dozen of tools me and my friends use daily. <strong>We save time, effort
                    and automate safety</strong>. <strong>CI works for us</strong>.
                <br>
                We have better sleep and more time for fun work. Yet, you might have missed them.
            </p>
            <p>
                I made this tiny page to put them all in single place and make it easy to use for
                everyone. Lazy coding!
            </p>
        </div>
                ...
                <div class="col-12 col-md-8 offset-md-2">
                    <div class="card mb-5 shadow">
                        <div class="card-body ps-4 pe-4">
                            ...
                            <div class="text-end">
                                @if ($tool->isNew())
                                    <div class="badge text-bg-success">Brand NEW</div>
                                    &nbsp;
                                @endif
                            ...
                            <h2 class="text-center"
                                style="font-size: 2em; margin: 2.5em 0;">{{ $tool->getName() }}</h2>
                            ...
                            <p>
                                ...
                                <textarea class="form-control mt-2"
                                          style="height: 2.5em; max-width: 40em">{{ $tool->getComposer() }}</textarea>
                            </p>
                            ...
                            @if ($tool->getTryCommands())
                                ...
                                <div class="card-body rounded bg-light border"
                                     style="border-color: #DDD;">
                                    @foreach ($tool->getTryCommands() as $label => $tryCommand)
                                        <div class="form-floating m-2">
                                            <textarea
                                                class="form-control">{{ $tryCommand }}</textarea>
                                            <label>{{ $label }}</label>
                            ...
                            @if ($tool->getPHPStanContents())
                                <p>
                                    <em class="text-secondary">Copy-paste to
                                        <code>phpstan.neon</code></em>

                                <div class="card-body rounded bg-light border"
                                     style="border-color: #DDD;">
                                    <textarea class="form-control border autoresize m-2"
                                              style="max-width: 32.8em">{{ $tool->getPHPStanContents() }}</textarea>
                                </div>
                                </p>
                            @endif
                        </div>
