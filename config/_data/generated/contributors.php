...
return static function (ContainerConfigurator $containerConfigurator): void {
    ...
    $parameters->set('contributors', [[
        ...
        'name' => 'ThomasLandauer',
        'url' => 'https://github.com/ThomasLandauer',
        'photo' => 'https://avatars1.githubusercontent.com/u/1054469?v=4',
        'contribution_count' => 4,
    ], [
        'name' => 'uestla',
        ...
        'name' => 'llaville',
        'url' => 'https://github.com/llaville',
        'photo' => 'https://avatars3.githubusercontent.com/u/364342?v=4',
        'contribution_count' => 1,
    ], [
        'name' => 'leoloso',
        'url' => 'https://github.com/leoloso',
        'photo' => 'https://avatars0.githubusercontent.com/u/1981996?v=4',
        'contribution_count' => 1,
    ], [
        'name' => 'simivar',
        'url' => 'https://github.com/simivar',
        'photo' => 'https://avatars3.githubusercontent.com/u/828020?v=4',
        'contribution_count' => 1,
    ]]);
};
